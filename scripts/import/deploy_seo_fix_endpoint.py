"""Uploads scripts/tornex-fix-category-seo.php to the WordPress root."""
import ftplib
import os
import time
...
LOCAL_FILE = os.path.join(ROOT, 'scripts', 'tornex-fix-category-seo.php')
REMOTE_PATH = 'public_html/tornex-fix-category-seo.php'
