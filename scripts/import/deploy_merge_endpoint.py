"""Uploads scripts/tornex-merge-dupes.php to the WordPress root."""
import ftplib
import os
import time
...
LOCAL_FILE = os.path.join(ROOT, 'scripts', 'tornex-merge-dupes.php')
REMOTE_PATH = 'public_html/tornex-merge-dupes.php'
