"""Uploads scripts/tornex-seo-diag.php to the WordPress root."""
import ftplib
import os
import time
...
LOCAL_FILE = os.path.join(ROOT, 'scripts', 'tornex-seo-diag.php')
REMOTE_PATH = 'public_html/tornex-seo-diag.php'
