"""Uploads scripts/tornex-recategorize.php to the WordPress root."""
import ftplib
import os
import time
...
LOCAL_FILE = os.path.join(ROOT, 'scripts', 'tornex-recategorize.php')
REMOTE_PATH = 'public_html/tornex-recategorize.php'
