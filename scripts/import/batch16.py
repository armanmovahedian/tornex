# -*- coding: utf-8 -*-
"""Batch 16: 20 products -- Schneider Acti9 3-pole (1-20A, Curve B/C)
and 2-pole (4-63A, Curve C) MCBs."""
import json
import os
...
POLE_DIMS = {
    ...
    3: "ارتفاع ۸۵ میلی‌متر، عرض ۵۴ میلی‌متر و عمق ۷۸.۵ میلی‌متر با وزن ۳۷۵ گرم",
}

POLE_FA = {2: "دو پل", 3: "سه پل"}
...
AUTHORED = [
    {"amp": 20, "poles": 3, "curve": "C"},
    {"amp": 6, "poles": 3, "curve": "B"},
    {"amp": 6, "poles": 3, "curve": "C"},
    {"amp": 4, "poles": 3, "curve": "B"},
    {"amp": 3, "poles": 3, "curve": "B"},
    {"amp": 3, "poles": 3, "curve": "C"},
    {"amp": 1, "poles": 3, "curve": "C"},
    {"amp": 2, "poles": 3, "curve": "B"},
    {"amp": 1, "poles": 3, "curve": "B"},
    {"amp": 16, "poles": 2, "curve": "B"},
    {"amp": 63, "poles": 2, "curve": "C"},
    {"amp": 50, "poles": 2, "curve": "C"},
    {"amp": 40, "poles": 2, "curve": "C"},
    {"amp": 32, "poles": 2, "curve": "C"},
    {"amp": 25, "poles": 2, "curve": "C"},
    {"amp": 20, "poles": 2, "curve": "C"},
    {"amp": 16, "poles": 2, "curve": "C"},
    {"amp": 10, "poles": 2, "curve": "C"},
    {"amp": 6, "poles": 2, "curve": "C"},
    {"amp": 4, "poles": 2, "curve": "C"},
]
...
if __name__ == "__main__":
    ...
    with open(os.path.join(DATA_DIR, "batch16_result.txt"), "w", encoding="utf-8") as f:
        f.write(result)
    print("done, see data/batch16_result.txt")
    ...
    progress["phase"] = "phase7_batch16_done"
