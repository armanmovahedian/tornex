<?php
/**
 * Title: بنر CTA پایانی
 * Slug: tornex/cta-banner
 * Description: بنر فراخوان به اقدام برای تماس با تورنکس
 * Categories: tornex
 * Viewport Width: 1400
 */
...
<p class="has-text-align-center">همین حالا با کارشناسان فروش تورنکس در تماس باشید.</p>
<!-- /wp:paragraph -->
